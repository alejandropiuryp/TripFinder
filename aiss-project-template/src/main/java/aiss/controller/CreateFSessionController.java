	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		...
		if(flightSessionResults!=null) {
			...
			if (searchID !=null && searchHash !=null) {
				...
				if (flightPollResults.getRecommendedItins()==null) {
					log.log(Level.FINE, "Error when getting itinerates ");
			...
			log.log(Level.FINE, "Error when getting params ");
		...
		rd.forward(request, response);
			...
			log.log(Level.FINE, "Error when creating Flight's Session ");
